...
export class FideicomitentesComponent
  ...
  implements OnInit
{
  ...
  public resumenComponentes = [
    {
      sigla: "EJ",
      nombre: "Ejército Bolivariano",
      activos: 1520,
      pendientes: 45,
      rechazados: 12,
      image: "assets/img/componentes/EJ.webp",
      bg: "rgba(89, 140, 137, 0.04)",
      border: "#598c89",
    },
    {
      sigla: "AR",
      nombre: "Armada Bolivariana",
      activos: 840,
      pendientes: 12,
      rechazados: 3,
      image: "assets/img/componentes/AR.webp",
      bg: "rgba(89, 140, 137, 0.04)",
      border: "#598c89",
    },
    {
      sigla: "AV",
      nombre: "Aviación Militar",
      activos: 630,
      pendientes: 18,
      rechazados: 5,
      image: "assets/img/componentes/AV.webp",
      bg: "rgba(89, 140, 137, 0.04)",
      border: "#598c89",
    },
    {
      ...
      pendientes: 62,
      rechazados: 18,
      image: "assets/img/componentes/GN.webp",
      bg: "rgba(89, 140, 137, 0.04)",
      border: "#598c89",
    },
  ];
  ...
  public mostrarAuditoria: boolean = false;
  public auditoriaComponente: string = "";

  public abrirAuditoria(comp: any): void {
    this.auditoriaComponente = comp.sigla || comp.nombre;
  ...
  private registrarNominaColeccion(uploadEventBody: any): void {
    ...
    this.apiService.post(endpoint, body).subscribe({
      ...
      error: (err) => {
        console.error(
          "[Fideicomitentes] Error al registrar en ccoleccion:",
          err,
        );
        this.utilService.AlertMini(
          "top-end",
